...
namespace BalanceManager.Controllers
{
    ...
    {
        // TODO: Create the following APIs:
        //  1.  Create Balance
        //          Input: N/A
        //          Output: The id of the new balance, id supposed to work as a sequence always the return the next number. 
        //                  For example if the currently the max id is 7 the new balance will be created with id 8.
        //  2.  Get Balance Info
        //          Input: Balance id
        //          Output: Balance Details, if balance doesn't exists return NotFound
        //  3. Charge
        //          Input: Balance id, amount to charge
        //          Output: If balance doesn't have sufficient amount return BadRequest with relevant message, 
        ...
        //          Output: If balance doesn't exist return BadRequest with relevant message
        //                  Else add the amount to it's balance and return OK
        //  5. Transfer 
        //          Input: Balance id from, Balance id to, amount to transfer
        //          Output: If either of the balances doesn't exist return BadRequest with relevant message,
